...
### Для клиентов (наших)
 ...
 - установить новый канал коммуникации с клиентами (через приложение)
 - получить целевой портрет клиента   
 - увеличить число заказов (из мобильного приложения до 30%)
 - найти своих клиентов не только в просторах веба, но и в просторах мобильных приложений 
...
(интерфейс мобильного приложения для сайта приближен к десктопной версии любых приложений, к которым пользователь больше привык, нежели представление в виде сайта)
